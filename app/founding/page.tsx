...
export const metadata = { title: "Founding Parents" };
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      <div className="inline-flex items-center gap-1.5 text-[12px] font-semibold px-2 py-1 rounded-sm bg-[#F5EFDD] text-[#B08D45] mb-4">
        <Sparkles size={12} /> Founding Parents
      </div>

      <h1 className="text-[26px] font-semibold text-[#1C1B19] mb-3 leading-snug">
        The first {status.cap} parents on Recess Forum
      </h1>
      ...
      {full ? (
        <p className="text-[14px] text-[#9A968A] italic mb-8">
          All {status.cap} founding spots have been claimed. Thank you to everyone who joined early.
      ...
      <div className="border-t border-[#E6E3DA] pt-6">
        ...
        <p className="text-[12px] text-[#9A968A] mt-5">
          Founding Parent badges are for parent accounts. We welcome business/service providers for educational purposes.
        </p>
      </div>
    </div>
  );
